...
/** Read-only smoke test: prints the parsed inventory list and which rows
 * currently qualify for a reorder prompt, without posting anything to Slack. */
async function main() {
  ...
  try {
    const items = await getInventoryItems({ client, logger: console });
